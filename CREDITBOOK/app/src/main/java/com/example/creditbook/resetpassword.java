...
public class resetpassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("SSSSSS " +license);
    }
    ...
    public void changePassword(View view) {
        ...
        Query checkUser = reference.orderByChild("adminliscene").equalTo(userID);
        checkUser.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    String oldPasswordDB = snapshot.child(userID).child("adminpassword").getValue(String.class);
                    if(oldPasswordDB.equals(oldPasswordFromUser)){
                        ...
                        if(!validatePassword()){
                            ...
                            progressDialog.dismiss();
                            reference.child(userID).child("adminpassword").setValue(newPasswordFormUser);
