...
public class QRscannerEntry extends AppCompatActivity implements ZXingScannerView.ResultHandler
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        dbref= FirebaseDatabase.getInstance().getReference("EntryScanInfo");
                ...
                dbref.push().setValue(pushDetails).
                        addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                QRScannerMainActivity.mtxt.setText("Dear "+Name+", Your entry has been recorded to Gyalpozhing College Of Information Technology");
                                onBackPressed();
                            }
                        });
            }
